...
function BusinessItem({ business, showDir = false }) {
  ...
  const calculateDistance = (lat1, lon1, lat2, lon2) => {
    ...
    setDistance(dist.toFixed(1)); // Keeping it 1 decimal
  ...
  return (
    <div className='w-[195px] p-2 rounded-lg shadow-md mb-1 bg-white hover:scale-110 transition-all mt-[20px] cursor-pointer flex-shrink-0'>
      <Image
